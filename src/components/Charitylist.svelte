<script>
  ...
  function calculateFunded(pleged, target){
    return Math.round((1/(target / pleged))*100);
  }
            ...
            <div class="col-lg-4 col-md-6">
              ...
              <div class="xs-popular-item xs-box-shadow">
                  ...
                  <div class="xs-skill-bar">
                    <div class="xs-skill-track">
                      <p><span class="number-percentage-count number-percentage" data-value="90"
                          data-animation-duration="3500">{calculateFunded(r.progres,r.target)}</span>%</p>
                    </div>
                  </div>
                ...
                <div class="xs-item-content">
                  ...
                  <a href="#" class="xs-post-title xs-mb-30">{r.title}</a>

                  <ul class="xs-list-with-content">
                    <li>{formatCurency(r.progres)}<span>Pledged</span></li>
                    <li><span class="number-percentage-count number-percentage" data-value="90"
                        data-animation-duration="3500">{calculateFunded(r.progres,r.target)}</span>% <span>Funded</span></li>
                    <li>{calculateDayRemaining(r.date_end)}<span>Days to go</span></li>
                  </ul>
                  ...
                  <div class="row xs-margin-0">
                    <div class="xs-round-avatar">
                      <img src="{r.profile_photo}" alt="">
                    </div>
                    <div class="xs-avatar-title">
                      <a href="#"><span>By</span>{r.profile_name}</a>
                    </div>
                  </div>

                  <span class="xs-separetor"></span>

                  <button type="submit" on:click={handleButton} data-toggle="modal" data-target="#exampleModal"
